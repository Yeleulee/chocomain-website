...
import { usePerformanceOptimization, observeWebVitals } from './hooks/usePerformanceOptimization';
...
// Lazy load FloatingImage component
...
const PageLoader = () => (
  <div className="min-h-screen bg-white flex items-center justify-center">
    <div className="text-center">
      ...
      <p className="text-luxury-dark font-accent">Loading...</p>
    </div>
  </div>
);
...
function App() {
  ...
  // Check bandwidth and optimize video loading
  useEffect(() => {
              ...
              <>
                ...
                <div className="relative h-screen overflow-hidden">
                  ...
                  <Suspense fallback={null}>
                    <FloatingImage
                      ...
                      className="w-24 h-24 md:w-32 md:h-32 top-20 left-10 z-20"
                      delay={0}
                      alt="Cinnamon cookie floating decoration"
                    />
                    <FloatingImage
                      src="/IMAGES/cookiee.jpg"
                      className="w-20 h-20 md:w-28 md:h-28 top-20 right-10 z-20"
                      delay={2}
                      alt="Cookie floating decoration"
                    />
                    <FloatingImage
                      src="/IMAGES/cookiechip.jpg"
                      className="w-28 h-28 md:w-36 md:h-36 bottom-32 left-20 z-20"
                      delay={4}
                      alt="Chocolate chip cookie floating decoration"
                    />
                  </Suspense>
                ...
                <section className="py-24 bg-gradient-radial from-white to-luxury-cream/30 relative">
                  ...
                  <Suspense fallback={null}>
                    <FloatingImage
                      src="/IMAGES/cookiee.jpg"
                      className="w-28 h-28 top-20 right-20 hidden lg:block"
                      delay={2}
                      alt="Cookie floating decoration"
                    />
                    <FloatingImage
                      src="/IMAGES/cinimon.jpg"
                      className="w-24 h-24 bottom-20 left-20 hidden lg:block"
                      delay={4}
                      alt="Cinnamon cookie floating decoration"
                    />
                  </Suspense>
                ...
                <section className="py-32 bg-white relative overflow-hidden">
                  ...
                  <Suspense fallback={null}>
                    <FloatingImage
                      ...
                      className="w-24 h-24 top-20 left-10 hidden lg:block"
                      delay={1}
                    ...
                    <FloatingImage
                      ...
                      className="w-32 h-32 bottom-20 right-10 hidden lg:block"
                      delay={3}
                      alt="Dessert decoration"
                    />
                  </Suspense>
